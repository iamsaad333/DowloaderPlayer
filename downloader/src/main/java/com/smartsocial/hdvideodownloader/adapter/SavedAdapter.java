...
package com.smartsocial.hdvideodownloader.adapter;
    ...
    public void onBindViewHolder(@NonNull SavedHolder holder, final int position) {
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri fileUri =  FileProvider.getUriForFile(context, context.getPackageName()+".provider", list.get(position));
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (i == R.id.download_delete) {
                    ...
                    Uri fileUri = FileProvider.getUriForFile(context, "com.smartsocial.hdvideodownloader.fileprovider", file);
